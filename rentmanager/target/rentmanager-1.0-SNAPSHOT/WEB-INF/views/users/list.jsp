								...
								<table class="table table-striped">
									...
									<c:forEach items="${listUsers}" var="user">
										<tr>
											...
											<td><a class="btn btn-primary" href="${pageContext.request.contextPath}/users/details">
													<i class="fa fa-play"></i>
												</a> 
												<a class="btn btn-success" href="${pageContext.request.contextPath}/users/update?id=${user.id}"> 
													<i class="fa fa-edit"></i>
												</a>
												<%-- <button type="submit" class="btn btn-danger" href="${pageContext.request.contextPath}/users/delete?id=${client.id}">
